    ...
    state.cartProducts.map(function (product) {
      return product.id === id
        ? product.quantity > count
          ...
          : alert(
              "Product count should not be greater than quantity of product!"
            )
        : null;
    });
  };
    ...
    <Box align="center">
      ...
      >
        ...
        <VStack marginLeft="10px">
          ...
          <Text marginLeft="10px" color="blue.600" fontSize="xl">
            ₹{data.price}
          </Text>
        </VStack>
        <Button marginLeft="10px" onClick={() => increaseCount(data.id)}>
